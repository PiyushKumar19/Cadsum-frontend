            ...
            <div className="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                    ...
                    <div className="mt-12">
                        ...
                        <ul className="mt-3">
                            <li className="flex items-center">
                                ...
                                <a target="blank" className="text-gray-500 text-sm ml-3">
                                    <small className="block">Mail us</small>
                ...
                <form className="ml-auo space-y-4">
                    ...
                    <textarea placeholder='Message' rows={6}
                        className="w-full rounded-md px-4 border text-sm pt-2.5 outline-gray-500"></textarea>
                    <button type='button'
                        className="text-white bg-orange-500 hover:bg-orange-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full">Send</button>
                </form>
            </div>
        </div>
    </div>
