    ...
    <div className='flex-col items-center justify-center '>
      <div className='bg-slate-100 h-auto text-slate-700'>
        ...
        <div className='flex mx-5 my-5'>
          <div className='w-3/4 '>
            <div className='grid m-5 mt-2 py-5 bg-[#FFFFFF] border-2 rounded-sm shadow-sm'>
              <div className='flex-col items-start justify-start'>
                <div className='flex items-center justify-start'>
                  <div className='w-3/4 h-64 mb-10'>
                    <label className='text-[#F97306] text-2xl font-medium
                      pl-4'>Description</label>
                    <br></br>
            ...
            <div
              className="absolute left-0 right-0 w-[100vw] m-0 bg-[#FFFFFF] border-2 rounded-sm shadow-sm h-auto p-1 text-black"
              style={{ marginLeft: "calc(-50vw + 50%)" }} // Centers the component
            >
              <div className="mx-0">
            ...
            <div className='grid m-10 mt-2 bg-[#FFFFFF] border-2 rounded-sm shadow-sm h-auto p-1 text-black'>
              <div className=' pb-4'>
              ...
              <div className='flex-col items-start justify-start'>
                <label className='text-[#F97306] text-2xl font-medium
                  pl-4'>Screenshots & Videos</label>
                  <br></br>
                  {/* <Image src="https://images.pexels.com/photos/27594192/pexels-photo-27594192/free-photo-of-ao-ngu-than-vietnam.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                    height={200} width={200} alt="Some image"></Image> */}
                <div className='p-10'>
                  <ImageCarousel />
                </div>
              </div>

              <div className='flex items-center justify-center text-orange-400 gap-3 font-normal'>
                <a href='/eula'>EULA</a>
                <a href='/faq'>FAQ</a>
          ...
          <div className='w-1/4 h-2/6'>
            <div className='my-2 bg-white shadow-sm shadow-gray-300 rounded-sm py-4 border border-slate-200'>
              <div className='flex items-center justify-center'>
