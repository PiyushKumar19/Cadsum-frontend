    ...
    return (
        <div>
            ...
            <div className=" text-base text-gray-900 font-normal ml-48 mr-48">
                ...
                <p className="mb-2 text-xl"><b>Comments</b></p>
                ...
                <p className="mb-2 text-xl"><b>Media</b></p>
                ...
                <p className="mb-2 text-xl"><b>Cookies</b></p>
                ...
                <p className="mb-2 text-xl"><b>Embedded content from other websites</b></p>
                ...
                <p className="mb-2 text-xl"><b>Who we share your data with</b></p>
                <p className="mb-4">If you request a password reset, your IP address will be included in the reset email.</p>
                <p className="mb-2 text-xl"><b>How long we retain your data</b></p>
                ...
                <p className="mb-2 text-xl"><b>What rights you have over your data</b></p>
                <p className="mb-4">If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.</p>
                <p className="mb-2 text-xl"><b>Where your data is sent</b></p>
                <p className="pb-20">Visitor comments may be checked through an automated spam detection service.</p>
            </div>
        </div>
    )
}
